...
contract Scalifyt5Token is StandardToken, Owned {
    ...
    function computeTokenAmount(uint256 ethAmount) public returns (uint256 tokens) {
      ...
      tokens = (ethAmount.mul(BASE_RATES[roundNum]))/1000000000000000000;///(1000000000000000000*4238)/100000000000000000
    ...
    function currentRoundIndexByDate() public view returns (uint8 roundNum) {
        uint256 currenttime = now;
